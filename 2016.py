...
for line in f.readlines():
  ...
  GDPperCapita.append(float(data[6]))
  #print(GDPperCapita)
  family.append(float(data[7]))
  #print(family)
  lifeExpectancy.append(float(data[8]))
  #print(lifeExpectancy)
  freedom.append(float(data[9]))
  #print(freedom)
  generosity.append(float(data[11]))
  #print(generosity)
  trust.append(float(data[10]))
  #print(trust)
